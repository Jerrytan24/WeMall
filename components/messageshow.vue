<template>
	<view class="m-item" :id="'message'+id">
		<view class="m-left">
			<image class="head_icon" :src="toSrc" v-if="message.user=='home'"></image>
		</view>
		...
		<view class="m-right">
			<image class="head_icon" :src="fromSrc" v-if="message.user=='customer'"></image>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		props: ['message', 'id','fromSrc','toSrc'],
